<?php
    ...
    if(
        ...
        $sql = "UPDATE shipping SET `destination` = '$destination', `origin` = '$origin', `datetime` = '$datetime' WHERE `tracking_id` = '$tracking_id'";
        ...
        echo '{"success": false, "message": "POST parameters required are: tracking id, origin, destination and datetime."}';
